...
topo_model = TopoModel(model_name='JoeShingleton/GeoLlama_7b_toponym', 
                       ...
                       instruct_path='topo_instruction.txt',
                       input_path=None,
                       config_path='model_config.json')

rag_model = RAGModel(model_name='JoeShingleton/GeoLlama_7b_RAG', 
                       prompt_path='prompt_template.txt',
                       instruct_path='rag_instruction.txt',
                       input_path='rag_input.txt',
                       config_path='model_config.json')
...
demo = gr.Interface(fn=geoparse, inputs='text', outputs=[output1, output2, output3])
demo.launch()